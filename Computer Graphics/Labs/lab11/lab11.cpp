...
void helpWindow() {
	...
	glutInitWindowPosition(0, 100);			// specify a window position
	SUB_WINDOW = glutCreateWindow("Help");
	glutHideWindow();
	myInit();

	string HELP =
		"Hello.\n"
		"Welcome to the help tutorial!"
		""
		""
		""
		""
	...
	for (int i = 0; i < HELP.length(); i++){
		glutBitmapCharacter(FONT, HELP[i]);
	}
	glutPostRedisplay();
}
...
void main()
{
	...
	MAIN_WINDOW = glutCreateWindow("Text Drawing/Menu Testing");	// create a titled window
